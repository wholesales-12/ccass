...
import { ArrowRight, PhoneCall, CheckCircle2, Sparkles, CalendarCheck, Mail } from "lucide-react"
import { Button } from "@/components/ui/button"

const PROOF = [
  { value: "5 min", label: "Go-live" },
  { value: "TRAI", label: "Registered" },
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-[#0a0612] shadow-[0_30px_80px_-30px_oklch(0.45_0.22_295/0.55)]">
          ...
          <div className="relative flex flex-col gap-8 px-6 py-10 sm:px-10 sm:py-12 lg:flex-row lg:items-center lg:justify-between lg:gap-12 lg:px-14">
            <div className="max-w-xl">
              ...
              <p className="mt-3 text-pretty text-[15px] leading-relaxed text-white/65">
                The next call your team picks up is either a chance to win a customer or a chance to lose one. Kedeyo
                makes sure your team is on the winning side — every time, in every language, on every channel.
              </p>
              ...
              <div className="mt-5 flex flex-wrap items-center gap-x-4 gap-y-2">
                {[
                  ...
                  <span key={p} className="inline-flex items-center gap-1.5 text-[11px] text-white/55">
            ...
            <div className="flex w-full max-w-md shrink-0 flex-col gap-3 lg:w-[360px]">
              ...
              >
                <Link href="tel:+917621073586" className="flex items-center justify-center gap-2">
              ...
              <a
                href="mailto:info@kedeyo.com"
                className="flex items-center justify-center gap-2 text-xs text-white/55 transition-colors hover:text-white"
              >
              ...
              <div className="mt-1 grid grid-cols-4 divide-x divide-white/10 overflow-hidden rounded-xl border border-white/10 bg-white/[0.03]">
                {PROOF.map((p) => (
                  <div key={p.label} className="px-2 py-2.5 text-center">
                    <div className="text-[12px] font-bold text-white">{p.value}</div>
